...
This is orthogonal to how you rule on the gate, and more time-critical than it. **A copy-off needs
cluster access, which is the same thing that is blocked.** See the accompanying preservation audit
for the precise at-risk inventory.
